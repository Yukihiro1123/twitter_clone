...
class ProfileLikesPart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: profileViewModel.getLikeResult(post.postId),
  ...
  _likeIt(BuildContext context) async {
    final profileViewModel = context.read<ProfileViewModel>();
    await profileViewModel.likeIt(post);
    await profileViewModel.getLikePosts();
  }

  _unlikeIt(BuildContext context) async {
    final profileViewModel = context.read<ProfileViewModel>();
    await profileViewModel.unlikeIt(post);
    await profileViewModel.getLikePosts();
  }
}
