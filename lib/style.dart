...
const commentNameTextStyle =
    TextStyle(fontFamily: BoldFont, fontSize: 13.0, color: Colors.grey);

const commentContentTextStyle =
    TextStyle(fontFamily: RegularFont, fontSize: 13.0, color: Colors.grey);

const commentInputTextStyle =
    TextStyle(fontFamily: RegularFont, fontSize: 14.0, color: Colors.grey);
...
//Setting
const settingTitleStyle = TextStyle(fontFamily: RegularFont, fontSize: 20.0);
const settingcaptionStyle = TextStyle(fontFamily: RegularFont, fontSize: 14.0);
